...
SECRET_KEY = 'django-insecure-^-aasg%@ip+xh7j0=$aa7-v84cnt=p(5*q#5*1l&ua8rlk(6^7'
...
# My settings.
LOGIN_REDIRECT_URL = 'django_py_crash:index'
LOGOUT_REDIRECT_URL = 'django_py_crash:index'
